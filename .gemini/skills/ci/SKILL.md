...
- **Test Failures**: Agent should run the specific `pnpm test` or `make test` command suggested.
- **Lint Errors**: Agent should run `make lint` or the specific package lint command.
- **Build Errors**: Agent should check `make build` output or build logs to resolve
  compilation issues.
