...
- [ ] Documentation update (e.g. contributing guide, architecture, README)
- [ ] Repository configuration / Tooling (CI/CD, dependencies, hooks)
...
- [ ] My code follows the code style and guidelines of this project (enforced by Biome).
